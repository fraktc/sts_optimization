...
| $6$ | | | | $\color{green}\text{0.00791311264038086 s (obj: 1)}$</br>$\color{green}\text{milp-model-1-HiGHS}$ | 
| $8$ | | | | $\color{green}\text{0.013290166854858398 s (obj: 1)}$</br>$\color{green}\text{milp-model-1-HiGHS}$ | 
| $10$ | | | | | 
| $12$ | | | | | 
| $14$ | | | | | 
| $16$ | | | | | 
